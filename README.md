...
# Awesome Android Things with stars
...
* [Serial Port Api](https://github.com/cepr/android-serialport-api) ⭐ 1,304 | 🐛 11 | 🌐 C | 📅 2015-09-02 - A library to access serial ports in Android.
...
* [sample-weatherstation](https://github.com/androidthings/weatherstation) ⚠️ Archived - Android Things Weather Station sample.
* [sample-simplepio](https://github.com/androidthings/sample-simplepio) ⚠️ Archived - Simple example of Android Things Peripheral I/O APIs.
* [drivers-sample](https://github.com/androidthings/drivers-samples) ⚠️ Archived - Android Things driver samples: RGB LED strip (APA102), Temperature sensor (BMP280), Capacitive touch (CAP12xx), UART GPS, Segment display (HT16k33), Accelerometer (mma7660fc), PWM servo, PWM speaker, SSD1306 OLED display, 4-Digit Segment Display (tm1637), RainbowHat, SenseHat
* [sample-simpleui](https://github.com/androidthings/sample-simpleui) ⚠️ Archived - Android Things Simple UI.
* [sample-button](https://github.com/androidthings/sample-button) ⚠️ Archived - Button and LED sample for Android Things.
* [sample-uartloopback](https://github.com/androidthings/sample-uartloopback) ⚠️ Archived - UART Loopback sample for Android Things.
* [sample-nativepio](https://github.com/androidthings/sample-nativepio) ⚠️ Archived - 3 simple examples using native c++ peripheral IO API.
* [sample-hd44780](https://github.com/leinardi/androidthings-drivers/tree/master/sample-hd44780) ⚠️ Archived - This sample demonstrates how to control the HD44780 LCD using PCF8574's I2C with Android Things.
* [sample-lsm9ds1](https://github.com/leinardi/androidthings-drivers/tree/master/sample-lsm9ds1) ⚠️ Archived - This sample demonstrates how to control the LSM9DS1 acceleration sensor and integrate it to the Android SensorManager.
...
* [Collision Detector](https://github.com/kevalpatel2106/collision-detector-android-things) ⭐ 10 | 🐛 0 | 🌐 Java | 📅 2017-05-11 - Get the distance of the object and alert using LED when object is too close using ultrasonic ranging sensor HC-SR04.
* [DoReFindMi](https://github.com/tomaszrykala/DoReFindMi) ⭐ 9 | 🐛 1 | 🌐 Kotlin | 📅 2018-07-31 - Musical, button combination-finding game for [Rainbow HAT for Android Things](https://shop.pimoroni.com/products/rainbow-hat-for-android-things).
* [Smart Switch](https://github.com/kevalpatel2106/smartswitch) ⭐ 9 | 🐛 0 | 🌐 Java | 📅 2017-05-10 - Control your home switches remotely from phone using Android Things & firebase realtime database.
* [Smart Room](https://github.com/carlosgub/Cuarto-Inteligente-Repo) ⭐ 5 | 🐛 0 | 🌐 Kotlin | 📅 2018-08-26 - This sample shows how turn on/off a light by using a Relay and Firebase. / Este ejemplo muestra como prender y apagar la luz usando un relay y firebase
* [candle](https://github.com/Polidea/at_candle) ⭐ 4 | 🐛 0 | 🌐 Kotlin | 📅 2017-01-11 - Simulation of a candle
* [example GPIO input](https://github.com/blundell/androidthings-gpio-input) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2018-03-13 - GPIO input (button) clean code sample
* [codelab button-Firebase](https://github.com/danybony/android-things-button-sample) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2017-02-15 Codelab starting from button input to Firebase sync
* [Smile Candy Machine](https://github.com/luisleao/smiledispenser) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2018-04-17 - Presented at Google I/O 2017 - a candy dispenser activated by smiles. Uses Google Cloud Vision API and Firebase.
* [example PWM](https://github.com/blundell/androidthings-pwm) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2019-01-14 - PWM (speaker/buzzer) clean code sample
* [example GPIO output](https://github.com/blundell/androidthings-gpio-output) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2018-03-13 - GPIO output (LED) clean code sample

### Drivers

* [contrib-drivers](https://github.com/androidthings/contrib-drivers/) ⚠️ Archived - Android Things Open source peripheral drivers: RGB LED strip (APA102), Temperature sensor (BMP280), Capacitive touch (CAP12xx), UART GPS, Segment display (HT16k33), Accelerometer (mma7660fc), PWM servo, PWM speaker, SSD1306 OLED display, 4-Digit Segment Display (tm1637), RainbowHat, SenseHat
* [RFID-RC522](https://github.com/Galarzaa90/android-things-rc522) ⚠️ Archived - RFID reader for MIFARE cards. Authentication, reading and writing.
* [DS3231](https://github.com/leinardi/androidthings-drivers/tree/master/driver-ds3231) ⚠️ Archived - real-time clock (RTC)
* [HC-SR04](https://github.com/leinardi/androidthings-drivers/tree/master/driver-hcsr04) ⚠️ Archived - ultrasonic ranging module
* [HD44780](https://github.com/leinardi/androidthings-drivers/tree/master/driver-hd44780) ⚠️ Archived - alphanumeric dot matrix LCD
* [LSM9DS1](https://github.com/leinardi/androidthings-drivers/tree/master/driver-lsm9ds1) ⚠️ Archived - 3D accelerometer, 3D gyroscope, 3D magnetometer and temperature sensor
* [SH1106](https://github.com/leinardi/androidthings-drivers/tree/master/driver-sh1106) ⚠️ Archived - OLED display
* [TSL256x](https://github.com/leinardi/androidthings-drivers/tree/master/driver-tsl256x) ⚠️ Archived - Light-to-digital sensor driver
* [1602 LCD display](https://github.com/Nilhcem/1602A-androidthings) ⭐ 29 | 🐛 0 | 🌐 Java | 📅 2018-05-10 - 1602 LCD display
...
* [SoftPwm](https://github.com/leinardi/androidthings-pio/tree/master/pio-softpwm) ⚠️ Archived - Software PWM library for Android Things
* [ULN2003](https://github.com/Polidea/Polithings/tree/master/uln2003) ⭐ 14 | 🐛 1 | 🌐 Kotlin | 📅 2019-06-07 - 28BYJ-48 Stepper motor with ULN2003 driver
* [HC-SR501 Motion Sensor](https://github.com/blundell/PirMotionSensorModuleTut) ⭐ 12 | 🐛 0 | 🌐 Java | 📅 2018-03-13 - Motion Sensor Driver with creation tutorial
* [MPR121](https://github.com/Nilhcem/mpr121-androidthings) ⭐ 11 | 🐛 0 | 🌐 Java | 📅 2018-05-10 - Proximity capacitive touch sensor
* [Bosh BMP85/BMP180](https://github.com/euler2dot7/android_things_bmp180) ⭐ 8 | 🐛 2 | 🌐 Java | 📅 2017-01-06 - Bosh BMP85/BMP180 barometer
* [ADXL345 3-axis accelerometer](https://github.com/cagdasc/AndroidThings-ADXL345) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2018-05-08 - ADXL345 3-axis accelerometer
* [Sparkfun](https://github.com/hcchoong79/androidthings) ⭐ 5 | 🐛 0 | 🌐 Java | 📅 2017-02-22 - Combined driver for the sparkfun blocks: OLEDBlock, LSM9DS0, UART
* [BH1750](https://github.com/alvarowolfx/bh1750-androidthings) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2018-09-03 - Light sensor
* [keypad](https://github.com/Nilhcem/keypad-androidthings) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2018-05-10 - Matrix Keypad
* [ADXL362 Accelerometer](https://github.com/vishal-android-freak/ADXL362-Interfacing-Library) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2017-01-11 - ADXL362 Accelerometer
* [HMC5883L 3-axis magnetometer](https://github.com/cagdasc/AndroidThings-HMC5883L) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2016-12-28 - HMC5883L 3-axis magnetometer
